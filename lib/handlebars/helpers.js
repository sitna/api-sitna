...
Handlebars.registerHelper("localeValue", function (value) {
    if (typeof (value) !== "object")
        throw "El parametro no es un objeto";
    return value[TC.i18n.currentLocaleKey] || value[TC.i18n.currentLocaleKey.substring(0, 2)] || value["es"] || value[Object.keys(value)[0]];
}); 
