...
export class Vector extends Layer {
    ...
    addMultiPoints(
        coordsOrMultiPointArray: Array<Array<number[] | MultiPoint>>,
        options?: object,
    ): Promise<MultiPoint[]>;
    ...
    addMultiMarkers(
        coordsOrMultiMarkerArray: Array<Array<number[] | MultiMarker>>,
        options?: object,
    ): Promise<MultiMarker[]>;
    ...
    addMultiPolyline(
        coordsOrMultiPolyline: Array<Array<number[]>> | MultiPolyline,
        options?: object,
    ): Promise<MultiPolyline>;
    addMultiPolylines(
        coordsOrMultiPolylineArray: Array<Array<Array<number[]>> | MultiPolyline>,
        options?: object,
    ): Promise<MultiPolyline[]>;
    ...
    addMultiPolygon(
        coordsOrMultiPolygon: Array<Array<Array<number[]>>> | MultiPolygon,
        options?: object,
    ): Promise<MultiPolygon>;
    addMultiPolygons(
        coordsOrMultiPolygonArray: Array<Array<Array<Array<number[]>>> | MultiPolygon>,
        options?: object,
    ): Promise<MultiPolygon[]>;
