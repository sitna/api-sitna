 ...
 * Initialization
 */
TC.version = '2.1.0 [2021-1-12 11:40:55]';
(function () {
    if (!TC.apiLocation) {
        var src;
        var script;
...
if (!TC.Consts) {
    ...
    TC.Defaults = (function () {
        ...
        return {
            ...
            *
            * Este control se usa habitualmente en combinación con `workLayerManager`, como se muestra en el ejemplo de {@link LayerCatalogOptions}.
